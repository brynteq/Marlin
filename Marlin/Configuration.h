...
#define STRING_CONFIG_H_AUTHOR "(Brent Fortune, XL+LS+AL GFXLCD)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,485}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {300, 300, 24, 25}    // (mm/sec)
